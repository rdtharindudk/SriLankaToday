...
public class QueryUtils {
    ...
    private static List<NewsItem> extractFeatureFromJson(String JSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                String headline = currentnewsitem.getString("title");
                String pubDate = currentnewsitem.getString("pubDate");
                String description = currentnewsitem.getString("description");
                String desc = Jsoup.parse(description).body().text();

                String link = currentnewsitem.getString("link");

                NewsItem newsItem = new NewsItem(headline,desc,link,pubDate);
